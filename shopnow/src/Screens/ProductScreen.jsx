...
const Product = () => {
  ...
  const HandleAddedItem = async() => {
    ...
    contextDispatch({type: 'Update_cart', payload: {...product, quantity: quantity}});
  }
  if(product)
  return (
        ...
        <div className='row'>
            ...
            <div className='mylcard container-fluid mt-5 col-lg-4 col-md-6 text-center'>
                <div className='myscard mx-3'>
                    ...
                    {product.Stock >0 && <button onClick={HandleAddedItem} className='btn btn-warning'>Add to cart</button>}
                </div>
            </div>
        </div>
    </div>
